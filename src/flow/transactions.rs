...
use millegrilles_common_rust::v3::{TransactionRouter, TransactionService};
...
impl KeyMasterTransactionService {
    pub fn new(mongo: Arc<dyn MongoDao>) -> Self {
    ...
    pub async fn process_ca(&self, wrapper: TransactionWrapper) -> Result<(), CommonError> {
